...
class BlogCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($query)
                ...
                ->editColumn('image', function ($data) use ($request) {
                    ...
                    $img = asset('sofaseller/module/blog_category/' . $data->image);
                ...
                ->editColumn('action', function ($data) use ($request) {
                    $editUrl = route('admin.add.update.blog.category', $data->id);
                    $deleteUrl = route('admin.delete.blog.category', $data->id);
                    $buttons = '';
        ...
        return view('admin.module.blog_category.index');
    }
    ...
    public function saveCategpry(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $category = BlogCategory::findOrNew($request->id);
            ...
            $fileName = null;
            $publicUserDocPath = public_path('sofaseller/module/blog_category');
    ...
    public function deleteCategory($id)
    {
        ...
        if (!empty($data->image) && file_exists(public_path('sofaseller/module/blog_category' . $data->image))) {
            unlink(public_path('sofaseller/module/blog_category' . $data->image));
        }
