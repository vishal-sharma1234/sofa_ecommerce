            ...
            <div class="modal-content">
                ...
                <div class="card">
                    <div class="modal-body">
                        <form method="post" id="recordForm" action="{{ route('admin.add.update.blog.category') }}"
                            ...
                            <div class="row g-2">
                                <div class="">
                                    <div class="col-md-12">
                                        <div class="card-body">
                                            <div class="mb-2">
                                                <label class="form-label text-dark" for="name">Category
                                                    Name</label><span class="text-danger">*</span>
                                                <input type="text" id="name" name="name"
                                                    placeholder="Enter category name" aria-label="name"
                                                    class="form-control">
    ...
    <script>
        $(function() {
            ...
            let table = $(".datatables-basic").DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.blogs.categories') }}",
                    data: function(d) {}
                },
                columns: [{
                        data: 'name',
            ...
            $("div.head-label").html('<h5 class="card-title mb-0">Blog Categories</h5>');
