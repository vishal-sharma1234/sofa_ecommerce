    ...
    <script>
        $(function() {
            ...
            datatableButtons.push({
                text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Add Blog</span>',
                className: "create-new btn btn-primary waves-effect waves-light",
                action: function() {
                    window.location.href = "{{ route('admin.add.update.blog') }}";
                }
            });
            ...
            $("div.head-label").html('<h5 class="card-title mb-0">Blogs</h5>');
