            ...
            <div class="modal-content">
                ...
                <div class="card">
                    <div class="modal-body">
                        <form method="post" id="recordForm" action="{{ route('admin.add.update.website.banner') }}" class="mb-0"
                                    ...
                                    <div class="col-md-12">
                                        <div class="card-body row">
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <label class="form-label text-dark" for="title">Banner Title</label><span class="text-danger">*</span>
                                                <input type="text" id="title" name="title"
                                                    placeholder="Enter Banner Title" aria-label="title" class="form-control">
                                                <small class="text-danger error-text title_error"></small>
                                            </div>

                                            <div class="col-md-12 mb-2">
                                                <label class="form-label text-dark" for="sub_title">Banner Sub Title</label><span class="text-danger">*</span>
                                                <input type="text" id="sub_title" name="sub_title"
                                                    placeholder="Enter Banner Sub Title" aria-label="sub_title" class="form-control">
                                                <small class="text-danger error-text sub_title_error"></small>
                                            </div>

                                            <div class="col-md-12 mb-2">
                                                <label class="form-label text-dark" for="image">Banner Image</label><span class="text-danger">*</span>
                                                <input type="file" id="image" name="image" aria-label="image" class="form-control">
    ...
    <script>
        $(function() {
            ...
            datatableButtons.push({
                text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Add Banner</span>',
            ...
            $("div.head-label").html('<h5 class="card-title mb-0">Banners</h5>');
