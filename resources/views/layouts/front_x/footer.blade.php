              ...
              <div class="col-lg-3 col-md-3 col-sm-6 footer-widget">
                ...
                <ul class="footer-widget__list">
                  ...
                  <li>
                    ...
                    ><a href="tel:846677028028" class="hover-style-link"
                      >+846677028028</a
                    >
                  </li>
                </ul>
          ...
          <div class="container-fluid container-fluid--cp-100">
            <div class="row align-items-center">
              <div class="col-lg-12 col-md-12">
                <span class="copyright-text text-center text-md-start"
                  >&copy; 2023 Helendo.
    ...
    <!-- Modal -->
    <div
      class="product-modal-box modal fade"
      id="prodect-modal"
      tabindex="-1"
      role="dialog"
    >
            ...
            <div class="row align-items-center">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="quickview-product-active mr-lg-5">
                  <a href="#" class="images">
                    <img
                      src="assets/images/product/2-570x570.webp"
                      class="img-fluid"
                      alt=""
                    />
                  </a>
                  <a href="#" class="images">
                    <img
                      src="assets/images/product/3-600x600.webp"
                      class="img-fluid"
                      alt=""
                    />
                  </a>
                  <a href="#" class="images">
                    <img
                      src="assets/images/product/4-768x768.webp"
                      class="img-fluid"
                      alt=""
                    />
                  </a>
                ...
                <div class="product-details-content quickview-content-wrap">
                  ...
                  <div class="product_meta mt-30">
                    ...
                    <div class="posted_in item_meta">
                      ...
                      ><a href="#">Furniture</a>, <a href="#">Table</a>
                    </div>
                  ...
                  <div class="product_socials section-space--mt_60">
                    ...
                    <ul class="helendo-social-share socials-inline">
                      ...
                      <li>
                        <a
                          class="share-google-plus helendo-google-plus"
                          href="#"
                          target="_blank"
                      ...
                      <li>
                        <a
                          class="share-pinterest helendo-pinterest"
                          href="#"
                          target="_blank"
                      ...
                      <li>
                        <a
                          class="share-linkedin helendo-linkedin"
                          href="#"
                          target="_blank"
    ...
    <!-- Modal -->
    <div
      class="header-login-register-wrapper modal fade"
      id="exampleModal"
      tabindex="-1"
      role="dialog"
      aria-hidden="true"
              ...
              <div class="tab-pane fade" id="tab_list_07" role="tabpanel">
                <form action="#" class="account-form-box">
                  ...
                  <p class="mt-15">
                    ...
                    <a href="#" class="privacy-policy-link" target="_blank"
                      >privacy policy</a
                    >.
                  </p>
                  <div class="button-box mt-25">
      ...
      <div class="mobile-menu-overlay__inner">
        ...
        <div class="mobile-menu-overlay__body">
          <div class="offcanvas-menu-header d-md-block d-none">
            <div
              class="helendo-language-currency row-flex row section-space--mb_60"
            >
          ...
          <nav class="offcanvas-navigation">
            <ul>
              <li class="has-children">
                ...
                <ul class="sub-menu">
                  <li>
                    <a href="index.html"><span>Home V1 â€“ Default</span></a>
                  </li>
                  <li>
                    <a href="index-7.html"><span>Home V2 â€“ Boxed</span></a>
                  </li>
                  <li>
                    <a href="index-8.html"><span>Home V3 â€“ Carousel</span></a>
                  </li>
                  <li>
                    <a href="index-11.html"
                      ><span>Home V4 â€“ Categories</span></a
                    >
                  </li>
                  <li>
                    <a href="index-10.html"
                      ><span>Home V5 â€“ Collection</span></a
                    >
                  </li>
                  <li>
                    <a href="index-5.html"
                      ><span>Home V6 â€“ Full Width</span></a
                    >
                  </li>
                  <li>
                    <a href="index-4.html"
                      ><span>Home V7 â€“ Left Sidebar</span></a
                    >
                  </li>
                  <li>
                    <a href="index-3.html"><span>Home V8 â€“ Metro</span></a>
                  </li>
                  <li>
                    <a href="index-2.html"><span>Home V9 â€“ Minimal</span></a>
                  </li>
                  <li>
                    <a href="index-6.html"
                      ><span>Home V10 â€“ Parallax</span></a
                    >
                  </li>
                  <li>
                    <a href="index-12.html"
                      ><span>Home V11 â€“ Video Feature</span></a
                    >
                  </li>
                  <li>
                    <a href="index-9.html"
                      ><span>Home V12 â€“ 02 Feature</span></a
                    >
                  </li>
                  <li>
                    <a href="index-13.html"
                      ><span>Home V13 â€“ 03 Feature</span></a
                    >
                  </li>
                </ul>
              </li>
                ...
                <ul class="sub-menu">
                    ...
                    <ul class="sub-menu">
                      ...
                      <li>
                        <a href="shop-6-column.html"
                          ><span>Shop 6 Columns</span></a
                        >
                      </li>
                      <li>
                        <a href="shop-categories.html"
                          ><span>Shop Categories</span></a
                        >
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="shop-with-boder.html"
                          ><span>Shop With Border</span></a
                        >
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="shop-without-gutter.html"
                          ><span>Shop Without Gutter</span></a
                        >
                      </li>
                    </ul>
                  </li>
                  <li class="has-children">
                    ...
                    <ul class="sub-menu">
                      ...
                      <li>
                        <a href="product-simple.html"><span>Simple</span></a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="product-groupped.html"
                          ><span>Groupped</span></a
                        >
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="product-image-swatches.html"
                          ><span>Image Swatches</span></a
                        >
                      </li>
                      <li>
                        <a href="product-countdown-timer.html"
                          ><span>With Countdown Timer</span></a
                        >
                      </li>
                    </ul>
                  </li>
              ...
              <li class="has-children">
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <a href="blog-listing.html"><span>Blog List</span></a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="blog-left-sidebar.html"
                      ><span>Blog Sidebar</span></a
                    >
                  </li>
                  <li>
                    <a href="single-blog-post.html"
                      ><span>Single Post V1</span></a
                    >
                  </li>
                  <li>
                    <a href="single-blog-post-2.html"
                      ><span>Single Post V2</span></a
                    >
                  </li>
                </ul>
              </li>
          ...
          <div class="mobile-menu-contact-info section-space--mt_60">
            ...
            <p>
              ...
              <br />support.center@unero.co <br />(0091) 8547 632521
            </p>
          </div>
          ...
          <div class="mobile-menu-social-share section-space--mt_60">
            ...
            <ul class="social-share">
              ...
              <li>
                <a href="#"><i class="social social_linkedin"></i></a>
              </li>
              <li>
          ...
          <ul class="minicart-list">
            <li class="minicart-product">
              ...
              <a class="product-item_img">
                <img
                  class="img-fluid"
                  src="assets/images/product/small/cart-01.webp"
                  alt="Product Image"
                />
              </a>
              <div class="product-item_content">
                <a class="product-item_title" href="product-details.html"
                  >Plant pots</a
                >
                <label>Qty : <span>1</span></label>
                <label class="product-item_quantity"
                  >Price: <span> $20.00</span></label
                >
              </div>
            </li>
            <li class="minicart-product">
              ...
              <a class="product-item_img">
                <img
                  class="img-fluid"
                  src="assets/images/product/small/cart-02.webp"
                  alt="Product Image"
                />
              </a>
              <div class="product-item_content">
                <a class="product-item_title" href="product-details.html"
                  >Teapot with black tea</a
                >
                <label>Qty : <span>1</span></label>
                <label class="product-item_quantity"
                  >Price: <span> $20.00</span></label
            ...
            <li class="minicart-product">
              ...
              <a class="product-item_img">
                <img
                  class="img-fluid"
                  src="assets/images/product/small/cart-03.webp"
                  alt="Product Image"
                />
              </a>
              <div class="product-item_content">
                    ...
                    <div class="product-cats section-space--mb_60 text-center">
                      ...
                      <label>
                        <input
                          ...
                          value="furniture"
                        />
                        <span class="line-hover">Furniture</span>
                      </label>
                      <label>
