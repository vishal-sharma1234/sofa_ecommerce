                ...
                E = function () {
                    function t(e) {
                        ...
                        if (function (t, e) {
                            ...
                            if (this.settings = {}, this.settings.cssPath = i, this.settings.themesPath = s, this.settings.cssFilenamePattern = a || "%name%.css", this.settings.displayCustomizer = void 0 === n || n, this.settings.controls = o || _, this.settings.defaultTextDir = "rtl" === r || C, this.settings.defaultHeaderType = l || O, this.settings.defaultMenuCollapsed = void 0 !== u ? u : T, this.settings.defaultContentLayout = void 0 !== c ? c : N, this.settings.defaultShowDropdownOnHover = void 0 === d || d, this.settings.defaultNavbarType = void 0 !== m ? m : L, this.settings.defaultFooterFixed = void 0 !== h ? h : A, this.settings.availableDirections = g || t.DIRECTIONS, this.settings.availableStyles = b || t.STYLES, this.settings.availableThemes = w || t.THEMES, this.settings.availableHeaderTypes = I || t.HEADER_TYPES, this.settings.availableContentLayouts = v || t.CONTENT, this.settings.availableLayouts = E || t.LAYOUTS, this.settings.availableNavbarOptions = F || t.NAVBAR_OPTIONS, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== D ? D : z), this.settings.styles = p || x, this.settings.navbarOptions = y || S, this.settings.defaultStyle = f || k, this.settings.lang = M || "en", this.pathResolver = q || function (t) {
                                return t
