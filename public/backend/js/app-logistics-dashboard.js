document.addEventListener("DOMContentLoaded", function(e) {
    var t = config.colors.textMuted,
        ...
        n = document.querySelector("#shipmentStatisticsChart"),
        s = {
            series: [{
                name: "Shipment",
                type: "column",
        ...
        t = (null !== n && new ApexCharts(n, s).render(), document.querySelector("#deliveryExceptionsChart")),
        n = {
            chart: {
                height: 365,
                parentHeightOffset: 0,
            ...
            series: [
             window.shipmentData.pickupScheduled,
             window.shipmentData.inTransit,
             window.shipmentData.ofd,
             window.shipmentData.issue,
             window.shipmentData.delivered,
             window.shipmentData.rto,
             window.shipmentData.rtoDelivered
         ],
            colors: [
                "#e5e58b",
                "#ffff4a",
        ...
        s = (null !== t && new ApexCharts(t, n).render(), document.querySelector(".dt-route-vehicles"));
    s && new DataTable(s, {
        ...
        responsive: {
            details: {
                ...
                renderer: function(e, t, o) {
                    var s, r, o = o.map(function(e) {
                        return "" !== e.title ? `<tr data-dt-row="${e.rowIndex}" data-dt-column="${e.columnIndex}">
                      <td>${e.title}:</td>
                      <td>${e.data}</td>
                    </tr>` : ""
                    }).join("");
                    return !!o && ((s = document.createElement("table")).classList.add("table", "datatables-basic", "mb-2"), (r = document.createElement("tbody")).innerHTML = o, s.appendChild(r), s)
                }
            }
        }
    }), setTimeout(() => {
        [{
            ...
            document.querySelectorAll(e).forEach(t => {
                o && o.split(" ").forEach(e => t.classList.remove(e)), s && s.split(" ").forEach(e => t.classList.add(e))
            })
        })
    }, 100)
});